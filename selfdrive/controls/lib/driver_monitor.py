...
_AWARENESS_TIME = 4800.  # one minute limit without user touching steering wheels make the car enter a terminal status
_AWARENESS_PRE_TIME_TILL_TERMINAL = 4700.  # a first alert is issued 25s before expiration
_AWARENESS_PROMPT_TIME_TILL_TERMINAL = 4600.  # a second alert is issued 15s before start decelerating the car
_DISTRACTED_TIME = 4800.
_DISTRACTED_PRE_TIME_TILL_TERMINAL = 4700.
_DISTRACTED_PROMPT_TIME_TILL_TERMINAL = 4600.
